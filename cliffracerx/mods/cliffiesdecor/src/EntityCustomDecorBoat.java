...
public class EntityCustomDecorBoat extends Entity
{
    ...
    public EntityCustomDecorBoat(World par1World)
    {
        super(par1World);
    ...
    public EntityCustomDecorBoat(World par1World, double par2, double par4, double par6, int id, int color)
    {
        this(par1World);
            ...
            if (!this.worldObj.isRemote)
            {
                ...
                if (list != null && !list.isEmpty())
                {
                    for (l = 0; l < list.size(); ++l)
                    {
                        ...
                        if (entity != this.riddenByEntity && entity.canBePushed() && entity instanceof EntityCustomDecorBoat)
                        {
