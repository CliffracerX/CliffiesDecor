...
public class DecorModFlowing extends BlockFluid
{
    /**
    ...
    protected DecorModFlowing(int par1, Material par2Material, int par3)
    {
        super(par1, par2Material);
        this.stoneBlockID=par3;
    }
    ...
    public void updateTick(World par1World, int par2, int par3, int par4, Random par5Random)
    {
        ...
        if (this.liquidCanDisplaceBlock(par1World, par2, par3 - 1, par4))
        {
            ...
            {
                par1World.setBlock(par2, par3 - 1, par4, this.stoneBlockID);
    ...
    private void flowIntoBlock(World par1World, int par2, int par3, int par4, int par5)
    {
        if (this.liquidCanDisplaceBlock(par1World, par2, par3, par4))
        {
            ...
            if (i1 > 0)
            {
                ...
                else if (i1 != Block.snow.blockID)//Forge was cursing about snow here.  o_O
                {
